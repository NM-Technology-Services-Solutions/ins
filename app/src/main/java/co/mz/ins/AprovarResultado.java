...
import co.mz.ins.Adapters.AdapterListInbox;
import co.mz.ins.Model.Inbox;

public class AprovarResultado extends AppCompatActivity {
    ...
    private class ActionModeCallback implements ActionMode.Callback {
        ...
        public boolean onCreateActionMode(ActionMode mode, Menu menu) {
            Tools.setSystemBarColor(AprovarResultado.this, R.color.colorDarkBlue2);
        ...
        public void onDestroyActionMode(ActionMode mode) {
            ...
            actionMode = null;
            Tools.setSystemBarColor(AprovarResultado.this, R.color.colorPrimary);
        }
    }
